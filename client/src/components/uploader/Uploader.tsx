    ...
    return (
        <Form onSubmit={handleSubmit}>
            <Form.Group>
                ...
                <div>
                    <FeedbackError show={validation.invalidProjectName}>Project should contain a file
                        called {folderName}.pde.</FeedbackError>
                    <FeedbackError show={validation.containsNoCodeFiles}>Project should contain at least one code
                        file.</FeedbackError>
                    <FeedbackError show={errors.upload}>Something went wrong while
                        uploading: {errors.upload}</FeedbackError>
                </div>
            </Form.Group>
