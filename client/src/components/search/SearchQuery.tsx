...
export function SearchQuery({state, handleResponse}: SearchQueryProperties) {
    ...
    return <Form>
        ...
        <Form.Label> Course:
            <Form.Group>
                <Loading<Course[]>
                    loader={getCourses}
                    component={courses =>
                        <Form.Control as="select" defaultValue={course}
        ...
        <Form.Label>Ordering
            <Form.Group>
                <Form.Control as="select" defaultValue={Sorting.datetime}
        ...
        <Form.Group>
            <InputGroup>
                <Form.Control type="text" onKeyDown={handleKeyDown} onKeyUp={handleKeyUp} placeholder="Search"
                              value={query}
