...
export function CommentSelector<T>({codeViewer, codeProperties, mentions, sendHandler}: CommentSelectorProperties<T>) {
	...
	return <Fragment>
		...
		{selecting ?
			 ...
			 */
			<Floater right={0} bottom={"calc(28px + 1.5rem)"} width="-webkit-fill-available" height="3rem" className="mx-n2 my-2 mb-n2">
				<CommentCreator
			...
			:
			<Floater right={0} bottom={"calc(28px + 1.5rem)"} width="3rem" height="3rem" className="mx-n2 my-2 mb-n2 text-right">
