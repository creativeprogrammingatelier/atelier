                ...
                <Modal show={this.props.show} onHide={this.props.onHide}>
                    ...
                    <Modal.Body>
                        <Form>
                            ...
                            <Button className="modalFormButton" type="button" onClick={(e: MouseEvent) => (this.props.user) ? this.deleteUser(e, this.props.user) : e.preventDefault()}><FiUserX /></Button>
                            <Button className="modalFormButton" type="submit" onClick={(e: MouseEvent) => (this.props.user) ? this.updateUser(e, this.props.user) : e.preventDefault()} ><FiTrash2 /></Button>
