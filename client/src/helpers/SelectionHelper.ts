...
export class SelectionHelper {
  /**
	 ...
	 * @param a: Selection 1
	 * @param b: Selection 2
	 * @return boolean: Whether selection a has priority over selection b
	 */
  ...
  /**
	 ...
	 * @param a: Selection 1
	 * @param b: Selection 2
	 * @return boolean: Whether selection a contains selection b
	 */
  ...
  /**
	 ...
	 * @param a: Selection 1
	 * @param b: Selection 2
	 * @return boolean: Whether selection a and selection b are the same
	 */
  ...
  /**
	 ...
	 * @param a: Selection 1
	 * @param b: Selection 2
	 * @return boolean: Whether selection a starts before selection b
	 */
  ...
  /**
	 ...
	 * @param a: Selection 1
	 * @param b: Selection 2
	 * @return boolean: Whether selection a ends after selection b
	 */
  ...
  /**
	 ...
	 * @param a: Selection
	 * @param b: Position
	 * @return boolean: Whether the position is inside the selection
	 */
