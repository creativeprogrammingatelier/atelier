...
export class ParameterHelper {
  /**
	 ...
	 * @return Key-Value object representation of string.
	 */
  ...
  /**
	 ...
	 * @return String representation of key-value object.
	 */
  ...
  /**
	 ...
	 * @return key-value object with the keys from the 'name' object inserted into params.
	 */
