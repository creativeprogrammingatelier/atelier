...
AuthHelper.getConfirm = () => {
    // Using jwt-decode npm package to decode the token
    let answer = jwt_decode_1.default(AuthHelper.getToken());
    console.log("Recieved answer!");
    return answer;
};
AuthHelper.fetch = (url, options) => {
...
AuthHelper._checkStatus = (response) => {
...
const PrivateRoute_1 = __importDefault(__webpack_require__(/*! ./PrivateRoute */ "./src/components/PrivateRoute.tsx"));
const Home_1 = __importDefault(__webpack_require__(/*! ./Home */ "./src/components/Home.tsx"));
...
class Login extends react_1.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("form", { onSubmit: this.onSubmit },
                react_1.default.createElement("h1", null, "Login"),
                react_1.default.createElement("input", { type: "email", name: "email", placeholder: "Enter email", value: this.state.email, onChange: this.handleInputChange, required: true }),
                react_1.default.createElement("input", { type: "password", name: "password", placeholder: "Enter password", value: this.state.password, onChange: this.handleInputChange, required: true }),
...
class TAView extends React.Component {
    render() {
        return (React.createElement("div", null,
            React.createElement("h1", null, "Hello Teaching Assistant")));
    }
}
exports.default = TAView;
