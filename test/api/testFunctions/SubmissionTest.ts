import { getSubmission, getSubmissionsByCourse, getSubmissionsByOwnCourseUser, getSubmissionsByOwnUser, getSubmissionsByOtherUser, getSubmissionsByOtherCourseUser, adminRegisterCourse, adminUnregisterCourse, adminSetPermissions } from "../APIRequestHelper";
