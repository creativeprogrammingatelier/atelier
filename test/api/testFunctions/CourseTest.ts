import { getCourse, getCourses, getCoursesByOwnUser, getCoursesByOtherUser, adminRegisterCourse, adminUnregisterCourse, adminSetPermissions, createCourse, updateCourse, registerUserCourse, USER_ID, unregisterUserCourse, deleteCourse } from "../APIRequestHelper";
